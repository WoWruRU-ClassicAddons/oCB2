...
function oCB:OnInitialize()
	...
	self.surface:Register("Otravi", "Interface\\AddOns\\oCB2\\textures\\oCB")
	self.surface:Register("Perl", "Interface\\AddOns\\oCB2\\textures\\perl")
	self.surface:Register("Smooth", "Interface\\AddOns\\oCB2\\textures\\smooth")
	self.surface:Register("Glaze", "Interface\\AddOns\\oCB2\\textures\\glaze")
	self.surface:Register("Striped", "Interface\\AddOns\\oCB2\\textures\\striped")
	self.surface:Register("BantoBar", "Interface\\AddOns\\oCB2\\textures\\BantoBar")
	self.surface:Register("Charcoal", "Interface\\AddOns\\oCB2\\textures\\Charcoal")
